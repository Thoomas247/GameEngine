...
void ImGui::TableBeginInitMemory(ImGuiTable* table, int columns_count)
{
	...
	span_allocator.Init(0, columns_count * sizeof(ImGuiTableColumn));
	span_allocator.Init(1, columns_count * sizeof(ImGuiTableColumnIdx));
	span_allocator.Init(2, columns_count * sizeof(ImGuiTableCellData), 4);
