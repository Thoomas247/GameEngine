...
struct ImSpanAllocator
{
    ...
    inline void  Init(int n, size_t sz, int a=4) { IM_ASSERT(n == CurrIdx && n < CHUNKS); CurrOff = IM_MEMALIGN(CurrOff, a); Offsets[n] = CurrOff; Sizes[n] = (int)sz; CurrIdx++; CurrOff += (int)sz; }
...
struct IMGUI_API ImPool
{
    ...
    void        Init(int capacity)               { Buf.reserve(capacity); Map.Data.reserve(capacity); }
