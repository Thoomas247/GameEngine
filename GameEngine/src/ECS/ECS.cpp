...
/* Older version not using templates
...
int ECS::CreateMeshComponent(Entity* entity, const VertexArrayAsset& vertexArray, const ShaderAsset& shader, const Material& material)
{
